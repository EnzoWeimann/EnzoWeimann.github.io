...
let proyectosArr = ["Person Management with Spring", "Budget app with Angular", "Inventory System with Spring and Angular", "Random quote generator", "Palindrome Checker with JS", "Showpping cart with JS"];
let urlArr = ["https://github.com/EnzoWeimann/People-Management-with-Spring", "https://github.com/EnzoWeimann/AppBudget", "https://github.com/EnzoWeimann/inventory-management-system", "https://codepen.io/Endage/pen/BagBLEp", "https://codepen.io/Endage/pen/OPPdJjW", "https://codepen.io/Endage/pen/KwwbvOd"];
let srcArr = ["/imagenes/Control_usuarios_index.png", "/imagenes/image1.png", "/imagenes/inventory-index.png", "./imagenes/random_quote.png", "./imagenes/palindrome.png", "./imagenes/shopping_cart.png"];
